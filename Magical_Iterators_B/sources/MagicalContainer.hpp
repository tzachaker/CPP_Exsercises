...
// AscendingIterator אופרטור ההקצאה מאפשר להקצות אובייקטים מהמחלקה 
//.זה לזה, תוך העתקת הערכים מאובייקט אחד לאחר
//הוא משמש בדרך כלל כדי להבטיח שהאובייקט שמוקצה אליו מקבל עותק של כל הנתונים הרלוונטיים מאובייקט המקור.
